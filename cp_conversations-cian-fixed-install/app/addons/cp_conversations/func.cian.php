...
function fn_cp_conversations_cian_request($method, $path, $payload = null, $query = array())
{
    ...
    // ЛОГИРОВАНИЕ: теперь внутри функции, ошибки Undefined variable не будет
    error_log("CIAN API Request | Method: $method | URL: $url | Payload: " . json_encode($payload));
...
/**
 * Отправка сообщения. Мы НЕ приводим ID к (int), чтобы не ломать строковые ID.
 */
